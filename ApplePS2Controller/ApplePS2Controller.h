...
private:
    ...
    //PS/2 Notification
    OSObject *              _ps2notificationTargetKeyboard;
    OSObject *              _ps2notificationTargetMouseTouchpad;
    PS2NotificationAction   _ps2notificationActionKeyboard;
    PS2NotificationAction   _ps2notificationActionMouseTouchpad;
    bool                    _ps2notificationInstalledKeyboard;
    bool                    _ps2notifiationInstalledMouseTouchpad;
    //
...
public:
    ...
    //PS/2 Notification
    virtual void installPS2Notification(PS2DeviceType   deviceType,
                                        OSObject *      target,
                                        PS2NotificationAction action);
    virtual void uninstallPS2NotificationAction(PS2DeviceType deviceType);
    virtual void dispatchPS2Notification(PS2DeviceType deviceType, UInt32 data);
    //
