...
void ApplePS2MouseDevice::installPS2NotificationAction(OSObject * target, PS2NotificationAction action)
{
    _controller->installPS2Notification(kDT_Mouse, target, action);
}

void ApplePS2MouseDevice::unistallPS2NotificationAction()
{
    _controller->uninstallPS2NotificationAction(kDT_Mouse);
}

void ApplePS2MouseDevice::dispatchPS2Notification(UInt32 data)
{
    _controller->dispatchPS2Notification(kDT_Keyboard, data);
}
