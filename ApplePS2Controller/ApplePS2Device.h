...
//
//Defines the Keyboard Notification Handler registered by a PS/2 device driver to
//intercept the keypress events on the PS/2 Controller, and to manage the touchpad
//accordingly
typedef  void (*PS2NotificationAction)(void * target, UInt32 data);

//Enumeration of 'data' values passed to KeyboardNotification Handler
//

enum touchpad {
    kPS2C_EnableTouchpad,
    kPS2C_DisableTouchpad,
    kPS2C_SwipeLeft,
    kPS2C_SwipeRight,
    kPS2C_SwipeDown,
    kPS2C_SwipeUp,
