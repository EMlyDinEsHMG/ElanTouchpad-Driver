...
public:
    ...
    //PS/2 Notification Routines
    
    virtual void installPS2NotificationAction(OSObject *, PS2NotificationAction);
    virtual void unistallPS2NotificationAction();
    
    //PS/2 Notification dispatcher
    
    virtual void dispatchPS2Notification(UInt32 data);
